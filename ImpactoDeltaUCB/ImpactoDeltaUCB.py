...
Deltas = np.linspace(0.05,0.5,nDeltas)
...
fig.savefig('ImpactoDeltaUCB1.pdf',format='pdf')
plt.show()
...
plt.ylim(0,500)
plt.legend(loc = 'upper right')
fig.savefig('ImpactoDeltaUCB2.pdf',format='pdf')
plt.show()
...
fig.savefig('ImpactoDeltaUCB3.pdf',format='pdf')
plt.show()
...
plt.ylim(0,100)
plt.legend(loc='upper left')
fig.savefig('ImpactoDeltaUCB4.pdf',format='pdf')
plt.show()
