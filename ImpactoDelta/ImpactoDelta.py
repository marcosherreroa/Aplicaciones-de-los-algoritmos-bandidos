...
nDeltas = 100
invDeltas = np.arange(1,1+nDeltas)
...
fig = plt.figure()
plt.plot(invDeltas,regretRandom,color =  'tab:green',label='Random')
plt.plot(invDeltas,regretEF, color = 'tab:blue', label='EF (m = m_Teor)')
...
plt.plot(invDeltas[20:],regretEF[20:], color = 'tab:blue', label='EF (m = m_Teor)')
